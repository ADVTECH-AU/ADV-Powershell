...
$yourLogo = "https://advprimarystorage.blob.core.windows.net/branding/Screenshot%202023-02-01%20164043.png"
$TableHeaderColour = "#0087FF"
$applicationName = "ADV Secure Score Exporter"
...
$appIdURI = "https://advtech.com.au/$((New-Guid).ToString())"
...
if ($graphsp) {
    ...
    $appCredential = @{
        ...
        #Secret = $appkey.value
        AppId = "df95cbaa-638d-4ba0-b8e7-5b4b97274e12"
        Secret = "~Eb8Q~tG.sBNfvRah-Ru7LCbdZZSjnq6xYmN4b7U"
        ...
        do {
            try {
                ...
                if ($scores) {
                    ...
                    $reportByLine = "<div>Secure Score report compiled by <strong>ADV Technical Consulting</strong> on $((Get-Date).ToLongDateString())</div>"
