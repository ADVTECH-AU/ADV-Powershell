#This script will set a random password for the local admin account and store it in a marker file. This marker file will be detected by the remediation script, which will then set the password in Intune.
