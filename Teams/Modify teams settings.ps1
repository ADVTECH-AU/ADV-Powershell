...
#[string]$settingsConfigFile="$env:userprofile\\AppData\Roaming\Microsoft\Teams\settings.json",
...
$newWebLanguage="en-au",
$desktopConfigFile="$env:userprofile\\AppData\Roaming\Microsoft\Teams\desktop-config.json",
$settingsConfigFile="$env:userprofile\\AppData\Roaming\Microsoft\Teams\settings.json",
...
$registryDisplayName="Microsoft Teams",
$processName="Teams"
...
$settingsconfig = (Get-Content -Path $settingsConfigFile | ConvertFrom-Json -ErrorAction SilentlyContinue)
