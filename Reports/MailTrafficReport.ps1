#This script will generate a report of mail traffic for the specified date range.
...
function main{
 ...
 Do
 {
  $MailTrafficData=Get-MailTrafficTopReport -StartDate $StartDate -EndDate $EndDate -Page $Page -PageSize 5000 | Where {$_.Name -match "ilaustralia.org.au"} | Sort-Object Date,Name,Direction
